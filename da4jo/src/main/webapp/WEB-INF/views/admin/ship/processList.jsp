	...
	<div class="container inner-container">
		<div class="content content-head">
			<div class="content-head-text">
				<i class="fa-solid fa-pause"></i> 배송대행 배송대기목록
			</div>
		</div>
		<div class="content content-body">
			<div class="cell listArea">
				<ul class="menu menu-type">
					...
					<li id="shipSvcPayDate"><strong>결제시간</strong></li>
				...
				<c:forEach var="shipSvcDto" items="${shipSvcDto}">
					<c:if test="${shipSvcDto.shipSvcStatus == '결제완료'}">
						<ul class="menu menu-list">
							...
							<li id="shipSvcDetail"><a href="processDetail?shipSvcNo=${shipSvcDto.shipSvcNo}"><i
			...
			<div class="cell searchArea center">
				<form action="processList" method="get">
					<select name="column" class="searchSelect">
						<option value="shipSvc_no" ${param.column == 'shipSvcDto_no' ? 'selected' : ''}>주문서</option>
						<option value="shipSvc_customer_id"
							${param.column == 'shipSvcDto_customer_id' ? 'selected' : ''}>주문자</option>
