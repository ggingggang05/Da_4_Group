	...
	<div class="container inner-container">
		<div class="content content-head">
			<div class="content-head-text">
				<i class="fa-solid fa-pause"></i> 배송대행 목록
			</div>
		</div>
		<div class="content content-body">
			<div class="cell listArea">
				<ul class="menu menu-type">
					...
					<li id="shipSvcContact"><strong>전화번호</strong></li>
				...
				<c:forEach var="shipSvcDto" items="${shipSvcDto}">
						<ul class="menu menu-list">
							...
							<li id="shipSvcContact">${shipSvcDto.shipSvcContact}</li>
							<li id="shipSvcAddress1">${shipSvcDto.shipSvcAddress1}</li>
							<li id="shipSvcStatus">${shipSvcDto.shipSvcStatus}</li>
							<li id="shipDetail"><a href="orderDetail?shipSvcNo=${shipSvcDto.shipSvcNo}"><i
			...
			<div class="cell searchArea center">
				<form action="orderList" method="get">
					<select name="column" class="searchSelect">
						...
						<option value="shipsvc_name_kor"
							${param.column == 'shipsvc_name_kor' ? 'selected' : ''}>주문자</option>
