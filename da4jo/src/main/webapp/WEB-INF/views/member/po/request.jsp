		...
		<div class="box_form">
			<form name="form_agency_buy_write" id="form_agency_buy_write"
				...
				<div class="area step step-agreement w-100">
					<div class="document_box left">
						...
						<p>정식 사이트나 공식 홈페이지가 아닌 경우 물건 미발송, 가품 등이 배송되는 등 피해가 발생 할 수
							있습니다.</p>
						<p>짐패스는 고객님의 신청서 작성대로 구매를 대행해 드리기 때문에 사이트에 대한 확인까지 불가하며 이로 인해
						...
						<p>- 적용할 수 있는 할인코드는 반드시 명시해 주시고 미기재로 인한 손해는 짐패스에서 책임지지 않습니다.</p>
						<p>- 고객님의 지정 아이디로 구매진행은 불가하며, 모든 구매는 짐패스가 해당사이트에 가입하여 짐패스의
							아이디로만 진행 가능합니다.</p>
						<p>- 고객님께서 신청하신 물품이 "짐패스" 또는 해외 다른 곳에서 같은 날 항공편으로 도착되거나, 세관에서
						...
						<p>- 합산과세가 걱정되시는 경우에는 [출고보류] 기능을 활용하시어 합산되지 않도록 순차 출고를 하시도록 권해
							드립니다.</p>
						<p>짐패스는 배송대행지로 과세에 대해서는 일절 개입이 불가하며 과세되는 경우 책임을 져 드릴 수 없으므로 꼭
							주의를 부탁 드립니다.</p>
						...
						<p>부득이한 사정으로 취소처리를 원하시는 경우 판매처에 반품/환불 가능 여부 확인 후 연락 드리도록
							하겠습니다.</p>
						<p>배송이 시작되어 반품을 해야 하는 경우 국가별로 책정된 짐패스 반품 수수료와 현지 내 반품 택배비(무료
							리턴이 아닌 경우)가 청구됩니다.</p>
						...
						<p>- 통관이 안 되는 이유로 반송 및 폐기처분 시 짐패스는 책임을 지지 않습니다.</p>
				...
				<h3>
					구매대행 상품정보 입력
					<p class="right red "
						style="font-size: 13px; margin: 5px 0 0;">단가는 상품 1개의 개별 가격을
						의미합니다.</p>
				</h3>
				<input name="contentData" type="hidden" />
				<div class="container w-800 left">
					<div class="cell">
				...
				<div class="button_area text-center">
					<a href="#" class="bt_close btn btn-lg btn-default"
						onclick="history.go(-1);">취소</a> <a href="#"
						class="bt_submit submitLoadingArea btn btn-lg btn-primary">신청서
						작성하기</a>
				</div>
			</form>
		</div>
...
<form action="request" method="post" autocomplete="off"></form>
