...
<div class="flex-cell">
	<div class="cell sfont">
		구매자(한글) <input type="text" name="shipSvcNameKor" class="tool w-100 line"
			placeholder="한글이름">
	</div>
	<div class="cell sfont">
		구매자(영문) <input type="text" name="shipSvcNameEng" class="tool w-100 line"
			placeholder="영어이름">
	</div>
	<div class="cell sfont">
		통관고유번호 <input type="text" name="shipSvcClearanceId" class="tool w-100 line"
			placeholder="P로시작">
	</div>
	<div class="cell sfont">
		연락처 <input type="text" name="shipSvcContact" class="tool w-100 line"
			placeholder="전화번호">
	</div>
</div>
<div class="cell left">
	<div class="cell">
		<input type="text" name="shipSvcZipcode" class="tool w-20 line"
			placeholder="우편번호">
	...
	<div class="cell">
		<input type="text" name="shipSvcAddress1" class="tool w-50 line"
			placeholder="기본주소">
	</div>
	<div class="cell">
		<input type="text" name="shipSvcAddress2" class="tool w-50 line"
			placeholder="상세주소">
	</div>
	<br>
</div>
