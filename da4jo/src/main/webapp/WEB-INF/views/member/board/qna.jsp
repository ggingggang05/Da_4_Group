	...
	<div class="container inner-container">
		...
		<div class="content content-body">
			<div class="cell listArea">
				<c:if test="${empty qnaList}"><!-- 구매서 작성 내역이 없는 경우 -->
					...
					<div class="cell center">
						<h2>
							<a href="/member/board/qna" class="btn"> 
								<i class="fa-solid fa-paper"style="color: #B2BC76;"></i> 문의 작성하러 가기
							</a>
						</h2>
					</div>
				</c:if><!-- 문의 내역이 없는 경우 닫는 태그 -->
				<c:if test="${!empty qnaList}"><!-- 문의 내역이 있는 경우 -->
					<div class="cell flex-cell">
						<div class="cell searchArea w-75 left"><!-- 검색 기능 -->
							<form action="list" method="get">
								<select name="column" class="searchSelect">
									...
									<option value="qna_wdate" ${param.column == 'qna_wdate' ? 'selected' : ''}>작성일</option>
								</select> 
						...
						<div class="cell w-25 right">
							<h2><a class="btn" href="/member/board/qna" style="color: #B2BC76;">문의 작성하기</a></h2>
						</div>
					</div>
					
					<ul class="menu menu-type">
						<li id="qnaNo"><strong>글번호</strong></li>
						<li id="qnaSecreat"><strong>비밀글</strong></li><!-- 아이템 이름 -->
					...
					<c:forEach var="qnaDto" items="${qnaList}">
						<ul class="menu menu-list">
							...
							<li id="qnaSecreat"><a href="/board/qna/detail?qnaNo=${qnaDto.qnaNo}" >${qnaDto.qnaSecreat}</li>
